global capitulo_archivo "capitulo8"
...
global p8 "c08_01_1 c08_01_2 c08_01_3 c08_01_4 c08_01_5 c08_01_6 c08_01_7 c08_01_8 c08_01_9 c08_01_10 c08_01_11 c08_01_89 c08_01_90" 
...
* Ejecutar función sobre todas las variables del capítulo 8
foreach VAR of varlist c08*{
	di "`VAR'"
	label32global `VAR'
}	
...
global pregunta p8
matrix ${pregunta} = J(26,9,.)
matrix colnames ${pregunta}= "Nada" ///
				   "muAAI"  "Nada-AAI" ///
				   "muSA"   "Nada-SA" ///
				   "muPP"   "Nada-PP" ///
				   "muPPSA" "Nada-PP&SA"
matrix rownames ${pregunta}= "$c08_01_1" "p" "$c08_01_2" "p" "$c08_01_3" "p" "$c08_01_4" "p" "$c08_01_5" "p" "$c08_01_6" "p" "$c08_01_7" "p" "$c08_01_8" "p" "$c08_01_9" "p" "$c08_01_10" "p" "$c08_01_11" "p" "$c08_01_89" "p" "$c08_01_90" "p"
...
putexcel set encuesta_capitulos.xlsx, sheet("Capituloc08") modify
putexcel A1="c_08"
