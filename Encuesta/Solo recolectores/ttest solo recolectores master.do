...
global dofiledir "${projectfolder}/Do/Encuesta/Solo recolectores"
...
* Capítulo 2
	preserve
	do "${dofiledir}/Hogares ttests Capitulo 2 solo recolectores.do"
	restore
* Capítulo 3
	preserve
	do "${dofiledir}/Hogares ttests Capitulo 3 solo recolectores.do"
	restore
* Capítulo 5
	preserve
	do "${dofiledir}/Hogares ttests Capitulo 5 solo recolectores.do"	
	restore
* Capítulo 7	
	preserve
	do "${dofiledir}/Hogares ttests Capitulo 7 solo recolectores.do"
	restore

* IPM
	preserve
	do "${dofiledir}/Hogares ttests IPM solo recolectores.do"
	restore
* End
