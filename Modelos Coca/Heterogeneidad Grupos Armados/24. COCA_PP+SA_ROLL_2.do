...
global output_path "${projectfolder}/Output/Modelos Coca Spillovers/_heterogeneidad grupos armados/estimaciones"
...
merge m:1 grilla using "${projectfolder}/Datos/grillas_t_2022.dta", gen(u1)
...
// cd "/Users/lucas_marinll/Dropbox/Lucas Marín Llanes/Investigación/2023/Evaluación PNIS-DNP/Cuanti-PNIS/Coca spillovers/BIS" 
...
*-------------------------------------------------------------------------------
	...
	estimates save "${output_path}/d_PPSA_ROLL_2.ster", replace
	...
	estimates save "${output_path}/v_PPSA_ROLL_2.ster", replace
	...
	estimates save "${output_path}/vv_PPSA_ROLL_2.ster", replace
	restore	
