...
DESCRIPCIÓN:
	En este script se producen y se exportan las tablas de resultados de PP&SA.
*/
...
* Componente en: Grilla PNIS - - - - - - - - - - - - - - - - - - - - - - - - - - 
	...
	* 3. Grilla PNIS vs Vecina
	estimates use "${dir_estimaciones}/d_PPSA_v.ster"
	...
	* 4. Grilla PNIS vs Vecina de Vecina
	estimates use "${dir_estimaciones}/d_PPSA_vv.ster"
	...
	* 5. Grilla PNIS vs Grilla PNIS pre PPSA
	...
	scalar N_OBS_5= e(N) 
		* Crear escalares para luego añadirlos en la creación de la tabla con ATT
		...
		qui estadd local TREND "\checkmark" // Tendencia
		qui estadd local CLVER "\checkmark" // Cluster por vereda
		qui estadd local CONTROL "{\scriptsize PP\&SA en 2022}" // pre PPSA
	...
	* 8. Grilla Vecina vs pre PP (PP en 2022)
	...
	scalar N_OBS_8= e(N) 
		* Crear escalares para luego añadirlos en la creación de la tabla con ATT
		...
		qui estadd local TREND "\checkmark" // Tendencia
		qui estadd local CLVER "\checkmark" // Cluster por vereda
		qui estadd local CONTROL "{\scriptsize PP\&SA en 2022}" // pre PP&SA
...
esttab modelo1 modelo2 modelo5 modelo6 modelo7 modelo8 modelo9 ///
	modelo10 modelo11 using "${table_output}/coca_spillover_att_PPSA.tex", replace ///
