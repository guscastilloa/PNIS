...
//
// 	* 3. Grilla PNIS vs Vecina de Vecina
...
* Componente en : Grilla Vecina - - - - - - - - - -	- - - - - - - - - - - - - - -
	* 54. Grilla Vecina vs Control Puro
...
* Componente en : Grilla Vecina de Vecina - - - - - - - - - - - - - - - - - - - 
	* 5. Grilla vecina de vecina vs Control Puro
...
esttab modelo1 modelo4 modelo5 ///
	using "${table_output}/coca_spillover_att_anuncioPNIS.tex", replace ///
