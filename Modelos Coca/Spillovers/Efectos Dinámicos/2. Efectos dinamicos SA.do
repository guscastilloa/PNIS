...
* Componente en: Grilla PNIS - - - - - - - - - - - - - - - - - - - - - - - - - - 
	...
	* Unir gráficos en uno combinado para exportar
	...
	graph export "${output_path}/ED-SA-grillasPNIS-spillovers.jpg", replace
...
* Componente en : Grilla Vecina - - - - - - - - - -	- - - - - - - - - - - - - - -
	...
	* Unir gráficos en uno combinado para exportar
	...
	graph export "${output_path}/ED-SA-Vecina-spillovers.jpg", replace
...
* Componente en : Grilla Vecina de Vecina - - - - - - - - - - - - - - - - - - - 
	...
	* Unir gráficos en uno combinado para exportar
	...
	graph export "${output_path}/ED-SA-VecinaVecina-spillovers.jpg", replace
