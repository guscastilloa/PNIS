...
* Componente en: Grilla PNIS - - - - - - - - - - - - - - - - - - - - - - - - - - 
	...
	* Unir gráficos en uno combinado para exportar
	...
	graph export "${output_path}/ED-PP-grillasPNIS-spillovers.jpg", replace
...
* Componente en : Grilla Vecina - - - - - - - - - -	- - - - - - - - - - - - - - -
	...
	* Unir gráficos en uno combinado para exportar
	...
	graph export "${output_path}/ED-PP-Vecina-spillovers.jpg", replace
...
* Componente en : Grilla Vecina de Vecina - - - - - - - - - - - - - - - - - - - 
	...
	* Unir gráficos en uno combinado para exportar
	...
	graph export "${output_path}/ED-PP-VecinaVecina-spillovers.jpg", replace
