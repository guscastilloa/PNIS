...
DESCRIPCIÓN:
	En este script se producen y se exportan las tablas de resultados de CC&SA.
*/
	...
	* 5. Grilla PNIS vs Grilla PNIS pre CC&SA
	...
	scalar N_OBS_5= e(N) 
		* Crear escalares para luego añadirlos en la creación de la tabla con ATT
		...
		qui estadd local TREND "\checkmark" // Tendencia
		qui estadd local CLVER "\checkmark" // Cluster por vereda
		qui estadd local CONTROL "{\scriptsize CC\&SA en 2022}" // Vecina de Vecina
	...
	* 8. Grilla Vecina vs pre CC&SA (CC&SA en 2022)
	...
	scalar N_OBS_8= e(N) 
		* Crear escalares para luego añadirlos en la creación de la tabla con ATT
		...
		qui estadd local TREND "\checkmark" // Tendencia
		qui estadd local CLVER "\checkmark" // Cluster por vereda
		qui estadd local CONTROL "{\scriptsize CC\&SA en 2022}" // pre PP
...
esttab modelo1 modelo2 modelo3 modelo4 modelo5 modelo6 modelo7 modelo8 ///
	modelo9 modelo10 modelo11 using "${table_output}/coca_spillover_att_CCSA.tex", replace ///
