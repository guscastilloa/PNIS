...
DESCRIPCIÓN:
	...
	de resultados de CC&SA de los modelos de deforestación.
*/
...
* Componente en: Grilla PNIS - - - - - - - - - - - - - - - - - - - - - - - - - - 
	...
	* Unir gráficos en uno combinado para exportar
	...
	graph export "${output_path}/ED-CCSA-grillasPNIS-defo.jpg", replace
...
* Componente en : Grilla Vecina - - - - - - - - - -	- - - - - - - - - - - - - - -
	...
	* Unir gráficos en uno combinado para exportar
	...
	graph export "${output_path}/ED-CCSA-Vecina-defo.jpg", replace
...
* Componente en : Grilla Vecina de Vecina - - - - - - - - - - - - - - - - - - - 
	...
	* Unir gráficos en uno combinado para exportar
	...
	graph export "${output_path}/ED-CCSA-VecinaVecina-defo.jpg", replace
