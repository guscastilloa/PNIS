...
save "${projectfolder}/Datos/base_estimaciones_deforestacion_grupos_armados.dta", replace
...
*-------------------------------------------------------------------------------
	...
	estimates save "${output_path}/d_PPSA_CP_0.ster", replace
	...
	estimates save "${output_path}/v_PPSA_CP_0.ster", replace
	...
	estimates save "${output_path}/vv_PPSA_CP_0.ster", replace
	...
	estimates save "${output_path}/d_PPSA_v_0.ster", replace
	...
	estimates save "${output_path}/d_PPSA_vv_0.ster", replace
	...
	estimates save "${output_path}/d_PPSA_AAI_0.ster", replace
	...
	estimates save "${output_path}/v_PPSA_AAI_0.ster", replace
	...
	estimates save "${output_path}/vv_PPSA_AAI_0.ster", replace
