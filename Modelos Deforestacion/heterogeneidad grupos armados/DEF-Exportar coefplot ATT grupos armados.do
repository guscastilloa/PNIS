...
global dir_estimaciones "${projectfolder}/Output/Deforestacion/_heterogeneidad grupos armados/estimaciones"


global dir_spill "${dir_estimaciones}/SPILL"
global dir_roll "${dir_estimaciones}/ROLL"
global output_path "${projectfolder}/Output/Deforestacion/_heterogeneidad grupos armados/graficos"
...
*-------------------------------------------------------------------------------
**# SPILL: Crear matrices con ATT, IC y p-valor para cada modelo
*-------------------------------------------------------------------------------
/*modelos SPILL (9):
...
coefplot matrix(E4ARMED0), ci((2 3)) vert yline(0, lpattern(dash)) ///
	...
	mlabcolor(stc6) mcolor(stc6) msymbol(Dh) aspect(1.4) name(g1, replace)  
...
coefplot matrix(E4ARMED1), ci((2 3)) vert yline(0, lpattern(dash)) ///
	...
	scheme(s1color) ciopts(lcolor(stc6) recast(rcap)) ///
	mlabcolor(stc6) mcolor(stc6) msymbol(Dh) aspect(1.4) name(g2, replace)  	
...
coefplot matrix(E4ARMED2), ci((2 3)) vert yline(0, lpattern(dash)) ///
	...
	scheme(s1color) ciopts(lcolor(stc6) recast(rcap)) ///
	mlabcolor(stc6) mcolor(stc6) msymbol(Dh) aspect(1.4) name(g3, replace)  		
...
graph export "${output_path}/defo-armed-esp4-AAI_PPSA-SPILL.jpg", replace
graph drop _all	
...
coefplot matrix(E4ARMED0), ci((2 3)) vert yline(0, lpattern(dash)) ///
	...
	mlabcolor(stred) mcolor(stred) msymbol(Dh) aspect(1.4) name(g1, replace)  
...
coefplot matrix(E4ARMED1), ci((2 3)) vert yline(0, lpattern(dash)) ///
	title("$ARMED1") ytitle("ATT") mlabel(@b) format("%9.3g") ///
	scheme(s1color) ciopts(lcolor(stred) recast(rcap)) ///
	mlabcolor(stred) mcolor(stred) msymbol(Dh) aspect(1.4) name(g2, replace)  	
...
coefplot matrix(E4ARMED2), ci((2 3)) vert yline(0, lpattern(dash)) ///
	title("$ARMED2") ytitle("ATT") mlabel(@b) format("%9.3g") ///
	scheme(s1color) ciopts(lcolor(stred) recast(rcap)) ///
	mlabcolor(stred) mcolor(stred) msymbol(Dh) aspect(1.4) name(g3, replace)  		
...
graph export "${output_path}/defo-armed-esp4-AAI_PPSA-ROLL.jpg", replace
graph drop _all	
