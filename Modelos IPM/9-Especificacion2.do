...
if ${switch_estimation_on}==1{
	* IPM 1
	...
	estimates save "${output_path}/estimaciones/esp2-${modelo}-${ipm}.ster", replace
...
if ${switch_estimation_on}==1{
	* IPM 1
	...
	graph export "${output_path}/graficos/esp2-${modelo}-${ipm}.jpg", replace
...
* End	   
// do "${projectfolder}/Do/9-Especificacion3.do"
