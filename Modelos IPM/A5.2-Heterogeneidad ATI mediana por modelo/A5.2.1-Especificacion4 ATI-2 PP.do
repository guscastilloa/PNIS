...
DESCRIPCIÓN.
	...
	de ATI fue 2=Recibió más o igual a la mediana. 
...
capture log close
log using "${projectfolder}/Log/A5-Especificacion4_ati2-mediana por modelo-PP.smcl", replace
...
* 3. Mantener solo observaciones en ATI==2.
preserve 
keep if d_ati==${n_ati}
tab year ejecucion_PNIS_prima
	global n_modelo 4
